...
<aside class='l_map'>
    ...
    <section class="r_info">
        <div class="detail_info">
            <span class="place_name">일조초밥</span>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2" class="tag">
                        <input type="button" value="오마카세">
                        <input type="button" value="데이트">
                        <input type="button" value="조용한">
                        <input type="button" value="을지로 4가">
                        <input type="button" value="종로 맛집">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <section class="review">
        ...
        <span  class="write">
            <table onclick="openWriteModal()">
                <tr><td>&nbsp;<i class="far fa-edit" id="write_btn"></i></td></tr>
                <tr><td>리뷰쓰기</td></tr>
            </table>
        </span>
            ...
            <div class="write_content">
                <form action="#">
                    <table class="write_form">
                        <tr><td><p id="write_title"> <span id="res_name">일조초밥</span> 어떠셨나요?</p></td></tr>
        ...
        <div id="review_modal" class="modal">
            ...
            <div class="review_modal_content">
                <div id="modal_profile_img"><img src="../images/burger.jpg" class="profile_img"></div>
                <div id="modal_profile">
                    <span class="username"><b>미식가</b></span>
                ...
                <div class="review_modal_btn"><input type="button" value="수정" id="review_edit"><input type="button" value="삭제" id="review_delete" onclick="check_delete()"></div>
                <br>
                <div class="review_contents">
                    가격도 적당하고 맛있었어요 조용해서 데이트코스에 넣어도 좋을 것 같네요 종로 주변에서 먹어본 초밥집중에 제일 괜찮았어요 을지로맛집 추천
                </div>
                <div class="review_modal_img">
                    <img src="../images/sushi.jpg" alt=""><img src="../images/sushi2.jpg" alt=""><img src="../images/sushi3.jpg"
                        alt="">
                </div>
            </div>
        </div>
        ...
        <div class="ind_review">
            <table>
                <tr>
                    ...
                    <td>
                        <span class="username"><b>고든램지</b></span>
        ...
        <div class="ind_review">
            <table>
                <tr>
                    ...
                    <td>
                        <span class="username"><b>제이미올리버</b></span>
