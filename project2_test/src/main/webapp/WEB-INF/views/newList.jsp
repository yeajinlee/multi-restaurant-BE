...
<body>
    ...
    <section class="info">
        <div>
            <div class="title">
                <div class="title_txt">
                    <b>닉네임님을 기다리고 있는 가게</b><br>
                    회원님 주변의 새로 개업한 가게들<br><br><br>
                    <div class="popup" onclick="popUp()"><u>왜 새로 개업한 가게들을 추천할까요?</u>
                        <span class="popuptext" id="myPopup">
                            멀티레스토랑은 지역의 외식 상권을 응원합니다!<br><br>
                            회원님 지역의 새로 개업한 가게에 방문하신 후 리뷰를 남겨 주시면<br>
                            가게 등급에 따라 더 많은 포인트가 적립됩니다
                        </span>
                      </div>
