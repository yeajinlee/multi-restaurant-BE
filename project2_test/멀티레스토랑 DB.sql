...
insert into review_info(review_NO, user_ID, review_scope, review_Text, rest_NO, review_Date)
    values (review_seq.nextval, 'a0001', 5, '테스트 리뷰2', 2, sysdate);
insert into review_info(review_NO, user_ID, review_scope, review_Text, rest_NO, review_Date)
    values (review_seq.nextval, 'a0001', 5, '테스트 리뷰2', 3, sysdate);
insert into review_info(review_NO, user_ID, review_scope, review_Text, rest_NO, review_Date)
    values (review_seq.nextval, 'a0001', 5, '테스트 리뷰2', 4, sysdate);
insert into review_info(review_NO, user_ID, review_scope, review_Text, rest_NO, review_Date)
    values (review_seq.nextval, 'a0001', 5, '테스트 리뷰2', 5, sysdate);
